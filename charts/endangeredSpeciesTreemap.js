...
import {
	endangeredAnimalsTreemapData as data,
...
const treemapDiv = d3.select("#endangered_species_treemap");

export const createEndangeredSpeciesTreemap = () => {
	// console.log(endangeredAnimalsTreemapData);
	// console.log(treemapDiv);
	...
	// .attr("class", "endangered_species_treemap-svg")
	// .attr("id", "endangered_species_treemap-svg");
