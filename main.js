...
// console.log(parkGeojson.features);
...
// console.log(animalBiodiversitySorted);

/*
console.log(
	plantByPark.get("Acadia National Park") +
		animalsByPark.get("Acadia National Park") ===
		parks.get("Acadia National Park")
);
*/
...
// console.log(conservationStatusByPark);
...
// console.log(endangeredPlantsTreemapData);
